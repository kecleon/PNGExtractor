...
{
	//source: https://gist.github.com/mjs3339/0772431281093f1bca1fce2f2eca527d
	public class BoyerMooreByteArrayScanner
	{
		private int[] _jumpTable;
		private byte[] _pattern;
		private int _patternLength;

		public BoyerMooreByteArrayScanner()
		{
		}

		public BoyerMooreByteArrayScanner(byte[] pattern)
		{
			_pattern = pattern;
